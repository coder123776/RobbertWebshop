  ...
  <div class="columns">
    ...
    <div class="column">
      <div class="details">
        ...
        <p class="description">Een opmerkelijke schoen die van nature zacht en behaaglijk is en bij elke beweging past.</p>
        ...
        <p class="small-text"><span>Standaard levering</span> 2-5 werk dagen</p>
        <p class="small-text"><span>Volgende dag geleverd</span> bestel vóór 14.00 uur ($ 5,79)</p>
